    ...
    for (var i = from; i < args.length; i++) {
        ...
        for (var j in type) {
            ...
            if (t === "array") {
                ...
                var belong = (typeof arg === "object" && arg.constructor === Object);
...
ArgPicker.prototype.last = ArgPicker.prototype.rfirst;
ArgPicker.prototype.lastSecond = ArgPicker.prototype.rsecond;
